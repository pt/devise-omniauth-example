...
FAQ
- I Get an error "REQUEST URI too large" when trying to authenticate with google open id
-- To fix this, (when using webrick), you need to increase the maximm length. In my case, I changed the file

/Users/abe/.rvm/rubies/ruby-1.9.2-p290/lib/ruby/1.9.1/webrick/httprequest.rb
